  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      switch (ordinalConverter.read(from)) {
        case 1:
          return new ContractError.InvalidOffer({ message: FfiConverterString.read(from) })
        case 2:
          return new ContractError.InvalidAccept({ message: FfiConverterString.read(from) })
        case 3:
          return new ContractError.InvalidSign({ message: FfiConverterString.read(from) })
        case 4:
          return new ContractError.InvalidFundingInput({ message: FfiConverterString.read(from) })
        case 5:
          return new ContractError.PsbtMismatch({ message: FfiConverterString.read(from) })
        case 6:
          return new ContractError.MissingFinalizedInput({ inputIndex: FfiConverterUInt32.read(from) })
        case 7:
          return new ContractError.UnsupportedScriptType({ inputIndex: FfiConverterUInt32.read(from) })
        case 8:
          return new ContractError.InvalidAttestation({ message: FfiConverterString.read(from) })
        case 9:
          return new ContractError.NoMatchingOutcome()
        case 10:
          return new ContractError.Descriptor({ message: FfiConverterString.read(from) })
        case 11:
          return new ContractError.Wallet({ message: FfiConverterString.read(from) })
        case 12:
          return new ContractError.Bip32({ message: FfiConverterString.read(from) })
        case 13:
          return new ContractError.Dlc({ message: FfiConverterString.read(from) })
        case 14:
          return new ContractError.Key({ message: FfiConverterString.read(from) })
        case 15:
          return new ContractError.Serialization({ message: FfiConverterString.read(from) })
        case 16:
          return new ContractError.InvalidNetwork({ message: FfiConverterString.read(from) })
        case 17:
  ...
  class FFIConverter extends AbstractFfiConverterByteArray<TypeName> {
    read(from: RustBuffer): TypeName {
      switch (ordinalConverter.read(from)) {
        ...
        case 5:
          return new DlcError.InvalidArgument({ message: FfiConverterString.read(from) })
        case 6:
          return new DlcError.SerializationError()
        case 7:
          return new DlcError.Secp256k1Error({ message: FfiConverterString.read(from) })
        case 8:
          return new DlcError.MiniscriptError()
        case 9:
          return new DlcError.InvalidNetwork()
        case 10:
          return new DlcError.KeyError({ key: FfiConverterTypeExtendedKey.read(from) })
        default:
          throw new UniffiInternalError.UnexpectedEnumCase()
      }
    }
