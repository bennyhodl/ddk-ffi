...
function uniffiEnsureInitialized() {
  ...
  if (nativeModule().uniffi_ddk_ffi_checksum_func_create_dlc_splice_input() !== 50727) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_ddk_ffi_checksum_func_create_dlc_splice_input')
  }
  if (nativeModule().uniffi_ddk_ffi_checksum_func_create_dlc_transactions() !== 60266) {
  ...
  if (nativeModule().uniffi_ddk_ffi_checksum_func_create_spliced_dlc_transactions() !== 55101) {
  ...
  if (nativeModule().uniffi_ddk_ffi_checksum_func_validate_offer() !== 24632) {
