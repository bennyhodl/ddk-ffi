 ...
 *
 *   src/node/generated/  generated TypeScript (committed; CI re-generates and diffs it)
 *   src/node/index.ts    hand-written entry around it
...
const GENERATED = join(PKG, 'src', 'node', 'generated')
