...
#   cd examples/react-native           working directory discarded
...
#   APK=examples/react-native/android/app/build/outputs/apk/release/app-release.apk \
#     ./packages/react-native/scripts/e2e-android.sh
