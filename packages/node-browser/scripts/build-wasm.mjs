 ...
 *
 *   browser/generated/   ubrn output: TypeScript (committed) + ddk_ffi.wasm (not)
 *   browser/index.ts     hand-written entry: `init()` with a default .wasm URL
 *   dist/wasm/            compiled ESM + .d.ts + the .wasm — the `browser`/`default`
 *                         conditions of `.`, and `./wasm`
 *
 * Requires:
...
const GENERATED = join(PKG, 'browser', 'generated')
