...
// `cargo test print_example_fixtures -- --ignored --nocapture` in ffi/.
...
// ffi/uniffi.toml), on this platform and in @bennyblader/ddk alike.
...
export default function App() {
  ...
  // codec at generation time (see tests/compatibility/ in the repo root), so a green run
